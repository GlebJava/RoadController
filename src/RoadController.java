...
public class RoadController {
    ...
    public static void main(String[] args) {
        Car skoda = new Car();
        skoda.setNumber("SV186D");
        System.out.println(skoda.getNumber());
        skoda.setHeight(120);
        System.out.println(skoda.getHeight());
        skoda.setWeight(1600);
        System.out.println(skoda.getWeight());
        skoda.setHasVehicle(false);
        System.out.println(skoda.getHasVehicle());
        skoda.setIsSpecial(true);
        System.out.println(skoda.getIsSpecial());
